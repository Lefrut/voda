...
import com.vodovoz.app.feature.filter_values.composable.FilterValuesBody

@Suppress("NonSkippableComposable")
@Composable
fun FilterValuesScreen(
    viewModel: FilterValuesViewModel,
    viewState: FilterValuesViewModel.ConcreteFilterState,
) {
    Scaffold(
        topBar = {
            HybridSearchTopBar(
